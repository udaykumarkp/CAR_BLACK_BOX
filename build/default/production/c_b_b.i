...
unsigned char log[11],sec,return_time;
...
{
    clear_display();
    clcd_print("ENTER THE PASS :",(0x80 + 0));
    cursor_on(0xC6);
}
char login(unsigned char *reset, unsigned char key)
{
    ...
    if(i==4 )
    {
        ...
        else
        {
            ...
            {
                clear_display();
                clcd_print("WRONG PASS",(0x80 + 0));
                clcd_putch(attempts + '0' , (0xC0 + 0));
...
char display_menu(unsigned char key , unsigned char * reset)
{
    ...
    {
        clcd_print("-> " , (0x80 + 0));
        clcd_print(menu[menu_pos] , (0x80 + 3));
        clcd_print(menu[menu_pos+1] , (0xC0 + 3));
    }
    else if(menu_pos == 4)
    {
        clcd_print("-> " , (0xC0 + 0));
        clcd_print(menu[menu_pos-1] , (0x80 + 3));
        clcd_print(menu[menu_pos] , (0xC0 + 3));
    }
