...
void view_log(unsigned char key ,unsigned char* reset)
{
    ...
    fetch_data_from_memory(pos);
    clcd_print(fetch_data , (0xC0 + 0));
}
void fetch_data_from_memory(unsigned char i)
{
...
{
    for(int i=0;i<100;i++)
    eeprom_at24C04_byte_write(0x05 + i , 0xFF);
    event = 0;
    pos = -1;
    clear_display();
}
...
void download_log(void)
{
    ...
    {
        clear_display();
        clcd_print("NO LOGS TO",(0x80 + 0));
        clcd_print("DOWNLOAD",(0xC0 + 0));
